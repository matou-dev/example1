...
(owned: 1 block + 2 items + 2 mobs + 2 weakspots + 1 feature
(distinct-drops tranche: my_beast pays my_gem x1, my_brute pays
my_brute_gem x2, both share bone `head` through the SYNTAX-V6 mob join);
...
WANT_OWNED = [("Block", 1), ("Item", 2), ("Mob", 2), ("Weakspot", 2),
        ("Feature", 1)]
